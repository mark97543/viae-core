...
interface PrintLayoutProps {
    paperSize: string; // 'letter', 'field-notes', 'custom-journal'
}
...
export default function PrintLayout({ paperSize }: PrintLayoutProps) {
    ...
    // Group waypoints for itinerary display
    const segments = [];
    if (routeData) {
    ...
    // Group segments by day based on isOvernight flag
    const days = [];
    ...
    // Chunking logic to ensure each page card fits on 1 physical PDF page
